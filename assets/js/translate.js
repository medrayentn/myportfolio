...
const translations = {
    en: {
        ...
        "about-text": "I am passionate about learning new approaches and am always on the lookout for efficient workflows. I'm an expert in creating responsive sites, landing pages, personal portfolios, and complex websites. Ever eager to grow and take on new challenges, I'm currently working at Clickora Agency, where I collaborate with real clients to turn ideas into functional, well-crafted websites. I'm continually striving to improve my skills and stay up to date with the latest in web development.",
        ...
        "skill-php-mysql-level": "Intermediate",
        "skill-mern": "MERN Stack",
        "skill-mern-level": "Learning",
    ...
    fr: {
        ...
        "skill-html-css": "HTML5 | CSS3",
        "skill-html-css-level": "Avancé",
        "skill-js": "JavaScript",
        "skill-js-level": "Intermédiaire",
        "skill-php-mysql": "PHP | MySQL",
        "skill-php-mysql-level": "Intermédiaire",
        "skill-mern": "MERN Stack",
        "skill-mern-level": "En apprentissage",
